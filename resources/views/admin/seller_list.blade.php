          ...
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <a href="{{route('admin.sellerProfile')}}" class="btn btn-outline-info btn-fw" style="float: right;">Add Seller</a>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="{{route('admin.sellerProfile')}}/{{ $list->id }}"><i class="mdi mdi-lead-pencil"></i></a> |
                                <a href="{{ route('admin.viewSeller', ['id' => $list->id]) }}"><i class="mdi mdi mdi-eye"></i></a>
