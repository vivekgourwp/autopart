                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="tab-content">
                      ...
                      <form class="forms-sample" method="post" action="{{route('admin.addSeller')}}" enctype="multipart/form-data" autocomplete="off">
                        {!! csrf_field() !!}
                          <div class="row">
                            <div class="form-group col-md-6">
                              <input type="hidden" name="user_id" value="{{$user_id}}">
                              <label for="exampleInputUsername1">Entity Representative Name</label>
                              <input  type="text" class="form-control form-control-sm" placeholder="Entity Representative Name" aria-label="Username" name="first_name" value="{{$first_name}}">
                            </div>
                            {{--<div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input required  type="text" class="form-control form-control-sm" placeholder="User Name" id="user_name_input" name="user_name" value="{{$user_name}}" oninput="checkUsernameAvailability()">
                              <small id="username_status" style="font-size: 13px; display: none;"></small>
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputEmail1">Email address</label>
                              <input  type="email" class="form-control form-control-sm" id="exampleInputEmail1" placeholder="Email" name="email" value="{{$email}}" autocomplete="off" readonly onfocus="this.removeAttribute('readonly')">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputEmail1">Password</label>
                              <input required type="password" class="form-control form-control-sm" id="exampleInputEmail1" placeholder="Password" name="password" value="" autocomplete="off" readonly onfocus="this.removeAttribute('readonly')">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1">Phone number1</label>
                              <input type="text" class="form-control form-control-sm" placeholder="Phone number1" aria-label="Username" name="mobile" value="{{$mobile}}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" minlength="4" maxlength="15">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1">Phone number2</label>
                              <input type="text" class="form-control form-control-sm" placeholder="Phone number2" aria-label="Username" name="mobile_2" value="{{$mobile_2}}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" minlength="4" maxlength="15">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1">Whatsapp number 1</label>
                              <input type="text" class="form-control form-control-sm" placeholder="Whatsapp number 1" aria-label="Username" name="whatsapp1" value="{{$whatsapp1}}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" minlength="4" maxlength="15">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1">Whatsapp number 2</label>
                              <input type="text" class="form-control form-control-sm" placeholder="Whatsapp number 2" aria-label="Username" name="whatsapp2" value="{{$whatsapp2}}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" minlength="4" maxlength="15">
                            </div> 
                            <div class="form-group col-md-6">
                              <label for="exampleInputEmail1">Gender</label>
                              <select  class="form-select form-select-sm" id="exampleFormControlSelect3" name="gender">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input  type="text" class="form-control form-control-sm" placeholder="Address Line 1" aria-label="Ussername" name="address1" value="{{$address1}}">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1">Address Line 2</label>
                              <input  type="text" class="form-control form-control-sm" placeholder="Address Line 2" aria-label="Usedrname" name="address2" value="{{$address2}}">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1">Zip Code</label>
                              <input  type="text" class="form-control form-control-sm" placeholder="Zip Code" aria-label="Usersname" name="zip_code" value="{{$zip_code}}">
                            </div>
                            <div class="form-group col-md-6">
                          ...
                          <div class="row">
                            <div class="form-group col-md-6">
                              ...
                              <input  type="text" class="form-control form-control-sm" id="exampleInputEmail1" placeholder="Entity Name" name="shop_name" value="{{$shop_name}}">
                            </div>

                            <div class="form-group col-md-6">
                              <label for="exampleInputEmail1">About Shop</label>
                              <textarea  class="form-control form-control-sm" name="about_shop" maxlength="300" id="short_bio">{{$about_shop}}</textarea>
                              <small id="bioCounter">300 characters remaining</small>
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputEmail1">Latitude</label>
                              <input  type="text" class="form-control form-control-sm" maxlength="12" id="latitude" placeholder="22.7124976" name="latitude" value="{{$latitude}}" pattern="^-?([1-8]?[0-9](\.\d+)?|90(\.0+)?)$"
         title="Enter a valid latitude between -90 and 90">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputEmail1">Longitude</label>
                              <input  type="text" class="form-control form-control-sm" maxlength="12" id="longitude" placeholder="75.8486807" name="longitude" value="{{$longitude}}" pattern="^-?((1[0-7][0-9]|[1-9]?[0-9])(\.\d+)?|180(\.0+)?)$"
         title="Enter a valid longitude between -180 and 180">
                            </div>

                            <div class="form-group col-md-6">
                              <label for="exampleInputEmail1">Shop Logo</label>
                              <input  type="file" class="form-control form-control-sm" id="shop_logo" name="shop_logo" accept="image/png, image/gif, image/jpeg">
                              <div>
                                  <img id="shop_logoPreview" src="{{ !empty($shop_logo) ? asset('public/uploads/shop_image/' . $shop_logo) :  asset('public/admin_assets/images/no_image.png') }}" 
                                      alt="shop Preview" style="max-width: 150px; border: 1px solid #ddd; padding: 5px;">
                              </div>
                            </div>

                            <div class="form-group col-md-6">
                              <label for="exampleInputEmail1">Shop Banner</label>
                              <input  type="file" class="form-control form-control-sm" id="shop_banner" name="shop_banner" accept="image/png, image/gif, image/jpeg">
                              <div>
                                  <img id="shop_bannerPreview" src="{{ !empty($shop_banner) ? asset('public/uploads/shop_image/' . $shop_banner) :  asset('public/admin_assets/images/no_image.png') }}" 
                                      alt="shop Preview" style="max-width: 150px; border: 1px solid #ddd; padding: 5px;">
                              </div>
                            </div>
