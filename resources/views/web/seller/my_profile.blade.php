...
@section('content')
        ...
        <div class="main-panel">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <!-- Tab panes -->
                      ...
                      <form class="forms-sample" method="post" action="{{route('seller.myProfile')}}" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                          <div class="row">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control form-control-sm" placeholder="{{__('messages.username')}}" id="user_name_input" name="user_name" value="{{$user_name}}" oninput="checkUsernameAvailability()"  >
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="password" class="form-control form-control-sm" id="exampleInputEmail1" placeholder="{{__('messages.password')}}" name="password" autocomplete="off" >
                            </div>
                            {{--<div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control form-control-sm" placeholder="{{__('messages.phone_num_1')}}" aria-label="Username" name="mobile" value="{{$mobile}}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" minlength="4" maxlength="15">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1">{{__('messages.phone_num_2')}}</label>
                              <input type="text" class="form-control form-control-sm" placeholder="{{__('messages.phone_num_2')}}" aria-label="Username" name="mobile_2" value="{{$mobile_2}}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" minlength="4" maxlength="15">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1">{{__('messages.whatsapp_1')}}</label>
                              <input type="text" class="form-control form-control-sm" placeholder="{{__('messages.whatsapp_1')}}" aria-label="Username" name="whatsapp1" value="{{$whatsapp1}}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" minlength="4" maxlength="15">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1">{{__('messages.whatsapp_2')}}</label>
                              <input type="text" class="form-control form-control-sm" placeholder="{{__('messages.whatsapp_2')}}" aria-label="Username" name="whatsapp2" value="{{$whatsapp2}}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" minlength="4" maxlength="15">
                            </div> 
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input  type="text" class="form-control form-control-sm" placeholder="{{__('messages.address1')}}" aria-label="Ussername" name="address1" value="{{$address1}}" >
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1">{{__('messages.address2')}}</label>
                              <input  type="text" class="form-control form-control-sm" placeholder="{{__('messages.address2')}}" aria-label="Usedrname" name="address2" value="{{$address2}}" >
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1">{{__('messages.address1_ar')}}</label>
                              <input  type="text" class="form-control form-control-sm" placeholder="{{__('messages.address1_ar')}}" aria-label="Ussername" name="address1_ar" value="{{$address1_ar}}" >
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1">{{__('messages.address2_ar')}}</label>
                              <input  type="text" class="form-control form-control-sm" placeholder="{{__('messages.address2_ar')}}" aria-label="Usedrname" name="address2_ar" value="{{$address2_ar}}" >
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1">{{__('messages.zip')}}</label>
                              <input  type="text" class="form-control form-control-sm" placeholder="{{__('messages.zip')}}" aria-label="Usersname" name="zip_code" value="{{$zip_code}}" >
                            </div>
                            <div class="form-group col-md-6">
                          ...
                          <div class="row">
                            <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control form-control-sm" id="exampleInputEmail1" placeholder="{{__('messages.shop_name')}}" name="shop_name" value="{{$shop_name}}">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputEmail1">{{__('messages.shop_name_ar')}}</label>
                              <input type="text" class="form-control form-control-sm" id="exampleInputEmail1" placeholder="{{__('messages.shop_name_ar')}}" name="shop_name_ar" value="{{$shop_name_ar}}">
                            </div>
         ...
         title="Enter a valid longitude between -180 and 180">
                            ...
                            <div class="form-group col-md-6">
                              <label for="exampleInputEmail1">{{__('messages.shop_logo')}}</label>
