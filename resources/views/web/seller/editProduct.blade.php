                    ...
                    {!! csrf_field() !!}
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input  type="text" class="form-control form-control-sm" placeholder="Product Description" aria-label="Username" name="product_description" value="{{$product_detail->product_description}}">
                        </div>
                        <div class="form-group col-md-6">
